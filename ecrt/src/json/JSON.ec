...
private:
   ...
   static inline JSONResult _GetValue(Class type, DataValue value, Container forMap, Class * rType)
   {
      ...
      bool (* onGetDataFromString)(void *, void *, const char *) = type ? (void *)type._vTbl[__eCVMethodID_class_OnGetDataFromString] : null;
      ...
      if( type && onGetDataFromString != type.base._vTbl[__eCVMethodID_class_OnGetDataFromString])
      {
         ...
         else
         {
            ...
            else
            {
               ...
               if(result)
               {
                  result = typeMismatch;
                  if(type)
                     ((void (*)(void *, void *))(void *)type._vTbl[__eCVMethodID_class_OnFree])(type, object);
               }
            }
         }
      }
      else if(isalpha(ch) || ch == '_')
      {
         ...
         if(result && type)
         {
            ...
            if( eCON & (type.type == enumClass || type.type == unitClass
               // || eClass_IsDerived(type, class(ColorAlpha)) || eClass_IsDerived(type, class(Color))
            ))
            {
               bool isColorAlpha = false; /*type.type != enumClass && type.type != unitClass &&
                  eClass_IsDerived(type, class(ColorAlpha)); // how to handle classes that derive from a special one in general?
               if(isColorAlpha)
                  type = class(Color); */
               // should this be set by calling __eCVMethodID_class_OnGetDataFromString ?
               if(((bool (*)(void *, void *, const char *))(void *)type._vTbl[__eCVMethodID_class_OnGetDataFromString])(type, &value.i, unqStr))
               {
                  if(isColorAlpha)
                     value.ui |= 0xFF000000;
                  result = success;
               ...
               if(cType && eClass_IsDerived(cType, type))
               {
                  ...
                  if(result)
                  {
                     ...
                     else
                     {
                        result = typeMismatch;
                        if(cType)
                           ((void (*)(void *, void *))(void *)cType._vTbl[__eCVMethodID_class_OnFree])(cType, object);
                     }
                  }
               }
               else if(ch != '=')
      ...
      */
      ...
      else
      {
         ...
         if(type.type == normalClass)
            ((void (*)(void *, void *))(void *)type._vTbl[__eCVMethodID_class_OnFree])(type, value.p);
      }
      return result;
   }
                                       ...
                                       if(isTemplateArg)
                                       {
                                          if(forMap && objectType.templateClass == class(MapNode))
                                          {
                                             if(isKey)
                                             {
                                                ...
                                                void (* onCopy)(void *, void *, void *) = keyClass._vTbl[__eCVMethodID_class_OnCopy];
...
static bool WriteNumber(File f, Class type, DataValue value, int indent, bool eCON, Map<String, const String> stringMap, bool useHex, bool jsonBitClass, bool forceQuotes)
{
   ...
   buffer[0] = 0;
   if(type == class(double) || !strcmp(type.dataTypeString, "double"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.d, buffer, 0, &onType);
   else if(type == class(float) || !strcmp(type.dataTypeString, "float"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.f, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "int64"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.i64, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "unsigned int64") || !strcmp(type.dataTypeString, "uint64") || type.typeSize == sizeof(int64))
   {
      if(useHex && eCON)
         ...
         ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.ui64, buffer, null, &onType);
   }
   else if(!strcmp(type.dataTypeString, "int"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.i, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "unsigned int") || !strcmp(type.dataTypeString, "uint") || type.typeSize == sizeof(int))
   {
      if(useHex && eCON)
         ...
         ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.ui, buffer, null, &onType);
   }
   else if(!strcmp(type.dataTypeString, "short") || !strcmp(type.dataTypeString, "int16"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.s, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "unsigned short") || !strcmp(type.dataTypeString, "uint16") || type.typeSize == sizeof(short int))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.us, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "char"))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.c, buffer, null, &onType);
   else if(!strcmp(type.dataTypeString, "unsigned char") || !strcmp(type.dataTypeString, "byte") || type.typeSize == sizeof(byte))
      ((const char *(*)(void *, void *, char *, void *, ObjectNotationType *))(void *)type._vTbl[__eCVMethodID_class_OnGetString])(type, &value.uc, buffer, null, &onType);
