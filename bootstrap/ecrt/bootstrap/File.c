...
extern void __eCNameSpace__eC__files__ChangeCh(char *  string, char ch1, char ch2);
...
__eCNameSpace__eC__files__ChangeCh(p, '\\', '/');
}
...
fprintf((bsl_stderr()), "WARNING:  File::Truncate unimplemented in ecrtBootstrap.\n");
return 0;
}
