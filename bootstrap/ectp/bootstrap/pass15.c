...
extern int __eCNameSpace__eC__types__UnescapeCString(char *  d, const char *  s, int len);
...
extern float (* __eCMethod_float_inf)(void);

extern float (* __eCMethod_float_nan)(void);

extern double (* __eCMethod_double_inf)(void);

extern double (* __eCMethod_double_nan)(void);
...
strcat(temp, "LL");
return __eCNameSpace__eC__types__CopyString(temp);
}
...
{
return __eCNameSpace__eC__types__UnescapeCString(d, s, len);
}
...
if(__eCProp_float_Get_isInf(result))
{
if(__eCProp_float_Get_signBit(result))
strcpy(temp, "-inf");
else
strcpy(temp, "inf");
}
else if(__eCProp_float_Get_isNan(result))
{
if(__eCProp_float_Get_signBit(result))
strcpy(temp, "-nan");
else
...
if(__eCProp_double_Get_isInf(result))
{
if(__eCProp_double_Get_signBit(result))
strcpy(temp, "-inf");
else
strcpy(temp, "inf");
}
else if(__eCProp_double_Get_isNan(result))
{
if(__eCProp_double_Get_signBit(result))
strcpy(temp, "-nan");
else
...
extern struct Statement * MkFireWatchersStmt(struct Expression * object, struct __eCNameSpace__eC__containers__OldList * watches);
...
static struct __eCNameSpace__eC__types__Class * currentClass;

struct __eCNameSpace__eC__types__Class * thisClass;

struct __eCNameSpace__eC__types__Class * containerClass;
...
extern struct Expression * GetTemplateArgExpByName(const char *  paramName, struct __eCNameSpace__eC__types__Class * thisClassFrom, struct __eCNameSpace__eC__types__Class * curClass, int tplType);
...
void SetThisClass(struct __eCNameSpace__eC__types__Class * c)
{
thisClass = c;
}

struct __eCNameSpace__eC__types__Class * GetThisClass()
{
return thisClass;
}
...
extern struct __eCNameSpace__eC__types__NameSpace *  globalData;
...
extern struct External * ProcessClassFunction(struct __eCNameSpace__eC__types__Class * owningClass, struct ClassFunction * func, struct __eCNameSpace__eC__containers__OldList * defs, struct External * after, unsigned int makeStatic);
...
struct __eCNameSpace__eC__types__Property * convert;
unsigned int isGet;
...
{
char * name = __eCNameSpace__eC__types__RSearchString(type->name, "::", strlen(type->name), 1, 0);
...
extern struct __eCNameSpace__eC__types__Instance * GetPrivateModule(void);
...
struct __eCNameSpace__eC__types__DefinedExpression
{
struct __eCNameSpace__eC__types__DefinedExpression * prev;
struct __eCNameSpace__eC__types__DefinedExpression * next;
const char *  name;
const char *  value;
...
static struct __eCNameSpace__eC__types__Class * __eCClass_Conversion;
...
{
struct __eCNameSpace__eC__types__Class * c = type->__anon1._class ? type->__anon1._class->__anon1.registered : (((void *)0));

_DeclareStruct(neededFor, c ? c->fullName : "eC::types::Instance", c ? c->type == 5 : 0, needDereference && c && c->type == 1, fwdDecl);
}
...
{
struct __eCNameSpace__eC__types__Class * sourceClass = source->kind == 8 ? source->__anon1._class->__anon1.registered : (((void *)0));
struct __eCNameSpace__eC__types__Class * destClass = dest->kind == 8 ? dest->__anon1._class->__anon1.registered : (((void *)0));
...
{
op.__anon1.i64 = __eCNameSpace__eC__types___strtoi64(exp->__anon1.__anon1.constant, (((void *)0)), 0);
op.ops = int64Ops;
}
else
{
op.__anon1.ui64 = __eCNameSpace__eC__types___strtoui64(exp->__anon1.__anon1.constant, (((void *)0)), 0);
op.ops = uint64Ops;
}
op.kind = 4;
break;
...
case 7:
if(!strcmp(exp->__anon1.__anon1.constant, "inf"))
op.__anon1.d = __eCMethod_double_inf();
else if(!strcmp(exp->__anon1.__anon1.constant, "-inf"))
op.__anon1.d = -__eCMethod_double_inf();
else if(!strcmp(exp->__anon1.__anon1.constant, "nan"))
op.__anon1.d = __eCMethod_double_nan();
else if(!strcmp(exp->__anon1.__anon1.constant, "-nan"))
op.__anon1.d = -__eCMethod_double_nan();
else
...
static long long GetEnumValue(struct __eCNameSpace__eC__types__Class * _class, void * ptr)
{
long long v = 0;
...
static void GetTypeSpecs(struct Type * type, struct __eCNameSpace__eC__containers__OldList * specs)
{
...
break;
case 27:
ListAdd(specs, MkSpecifier(FLOAT16));
break;
case 28:
ListAdd(specs, MkSpecifier(BF16));
break;
case 22:
...
break;
case 27:
strcat(string, type->isSigned ? "__Float16" : "unsigned _Float16");
break;
case 28:
strcat(string, type->isSigned ? "__bf16" : "unsigned __bf16");
break;
case 22:
...
unsigned int RelatedUnits(struct __eCNameSpace__eC__types__Class * c1, struct __eCNameSpace__eC__types__Class * c2)
{
if(c1->base->type == 3)
c1 = c1->base;
if(c2->base->type == 3)
...
static void FindNextDataMember(struct __eCNameSpace__eC__types__Class * _class, struct __eCNameSpace__eC__types__Class ** curClass, struct __eCNameSpace__eC__types__DataMember ** curMember, struct __eCNameSpace__eC__types__DataMember ** subMemberStack, int * subMemberStackPos)
{
if(*curMember)
{
...
static struct GlobalData * ScanGlobalData(struct __eCNameSpace__eC__types__NameSpace * nameSpace, char * name)
{
struct __eCNameSpace__eC__containers__BinaryTree * tree = &nameSpace->functions;
struct GlobalData * data = (struct GlobalData *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindString((&*tree), name);
...
static struct Symbol * ScanWithNameSpace(struct __eCNameSpace__eC__containers__BinaryTree * tree, const char * nameSpace, const char * name)
{
int nsLen = strlen(nameSpace);
struct Symbol * symbol;

for(symbol = (struct Symbol *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindPrefix(tree, nameSpace); symbol; symbol = (struct Symbol *)__eCProp___eCNameSpace__eC__containers__BTNode_Get_next(((struct __eCNameSpace__eC__containers__BTNode *)symbol)))
{
...
__eCInstance1->kind = 1, __eCInstance1->refCount = 1, __eCInstance1;
});
}
...
__eCInstance1->kind = 13, __eCInstance1->__anon1.type = source, __eCInstance1->refCount = 1, __eCInstance1;
});
source->refCount++;
}
return type;
...
static struct Symbol * FindWithNameSpace(struct __eCNameSpace__eC__containers__BinaryTree * tree, const char * name)
{
int c;
char nameSpace[1024];
const char * namePart;
...
if(c >= 0)
{
struct Symbol * symbol = (struct Symbol *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindString(tree, name);
...
{
struct Symbol * symbol = (struct Symbol *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindString(tree, namePart);
...
{
char * name = __eCNameSpace__eC__types__RSearchString(s, "::", strlen(s), 1, 0);
...
{
if(!symbol)
symbol = data->symbol = __eCNameSpace__eC__types__eInstance_New(__eCClass_Symbol);
}
if(!data->dataType)
...
if(curExternal)
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*ast), curExternal->prev, external);
...
__eCMethod_External_CreateUniqueEdge(neededFor, symbol->__anon2.__anon1.pointerExternal, 0);
}
...
symbol = (struct Symbol *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindString((isStruct ? &ctx->structSymbols : &ctx->symbols), name);
...
__eCMethod_External_CreateUniqueEdge(curExternal, symbol->__anon2.__anon1.pointerExternal, symbol->__anon2.__anon1.pointerExternal->type == 0);
return symbol;
}
...
static void IdentifyAnonStructs(struct __eCNameSpace__eC__containers__OldList * definitions)
{
struct ClassDef * def;
int anonID = 1;
...
struct __eCNameSpace__eC__types__ClassTemplateArgument * FindTemplateArg(struct __eCNameSpace__eC__types__Class * _class, struct TemplateParameter * param)
{
struct __eCNameSpace__eC__types__ClassTemplateArgument * arg = (((void *)0));
int id = 0;
...
if(arg && param->type == 0)
(*arg).__anon1.__anon1.dataTypeClass = __eCNameSpace__eC__types__eSystem_FindClass(_class->module, (*arg).__anon1.__anon1.dataTypeString);
}
return arg;
}

struct Context * SetupTemplatesContext(struct __eCNameSpace__eC__types__Class * _class)
{
...
{
struct TemplatedType * type = (type = __eCNameSpace__eC__types__eInstance_New(__eCClass_TemplatedType), type->key = (uintptr_t)param->identifier->string, type->param = param, type);

__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&curContext->templateTypes, (struct __eCNameSpace__eC__containers__BTNode *)type);
}
}
}
else if(_class)
...
char * ReplaceThisClass(struct __eCNameSpace__eC__types__Class * _class)
{
...
return __eCNameSpace__eC__types__CopyString(className);
}
else
return __eCNameSpace__eC__types__CopyString(_class->fullName);
}

struct Type * ReplaceThisClassType(struct __eCNameSpace__eC__types__Class * _class)
{
struct Type * type;
...
static int DeclareMembers(struct External * neededBy, struct __eCNameSpace__eC__types__Class * _class, unsigned int isMember)
{
struct __eCNameSpace__eC__types__DataMember * topMember = isMember ? (struct __eCNameSpace__eC__types__DataMember *)_class : (((void *)0));
struct __eCNameSpace__eC__types__DataMember * member;
...
case 2:
{
DeclareMembers(neededBy, (struct __eCNameSpace__eC__types__Class *)member, 1);
break;
}
}
}
...
void ProcessMethodType(struct __eCNameSpace__eC__types__Method * method)
{
if(!method->dataType)
{
...
void ProcessPropertyType(struct __eCNameSpace__eC__types__Property * prop)
{
if(!prop->dataType)
{
...
void ReplaceThisClassSpecifiers(struct __eCNameSpace__eC__containers__OldList * specs, struct __eCNameSpace__eC__types__Class * _class)
{
...
static unsigned int ResolveIdWithClass(struct Expression * exp, struct __eCNameSpace__eC__types__Class * _class, unsigned int skipIDClassCheck)
{
...
struct __eCNameSpace__eC__types__ClassProperty * classProp = (((void *)0));
...
{
struct __eCNameSpace__eC__types__EnumClassData * e = (baseClass ? ((void *)(((char *)baseClass->data) + enumClass->offsetClass)) : (((void *)0)));
...
exp->__anon1.__anon1.constant = __eCNameSpace__eC__types__CopyString(constant);
}
exp->expType = MkClassType(baseClass->fullName);
break;
}
...
if((method = __eCNameSpace__eC__types__eClass_FindMethod(_class, id->string, privateModule)))
{
ProcessMethodType(method);
exp->expType = __extension__ ({
struct Type * __eCInstance1 = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);

__eCInstance1->refCount = 1, __eCInstance1->kind = 16, __eCInstance1->__anon1.__anon3.method = method, __eCInstance1->__anon1.__anon3.methodClass = (skipIDClassCheck || (id && id->_class)) ? _class : (((void *)0)), __eCInstance1;
});
return 1;
}
else if((prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, id->string, privateModule)))
{
if(!prop->dataType)
...
else if((member = __eCNameSpace__eC__types__eClass_FindDataMember(_class, id->string, privateModule, (((void *)0)), (((void *)0)))))
{
if(!member->dataType)
member->dataType = ProcessTypeString(member->dataTypeString, 0);
...
else if((classProp = __eCNameSpace__eC__types__eClass_FindClassProperty(_class, id->string)))
{
...
void DeclareProperty(struct External * neededBy, struct __eCNameSpace__eC__types__Property * prop, char * setName, char * getName)
{
...
__eCInstance1->name = __eCNameSpace__eC__types__CopyString(prop->_class->fullName), __eCInstance1->isRemote = prop->_class->isRemote, __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__OldList_Add(&module->classes, classSym->_import);
}
symbol = prop->symbol = __eCNameSpace__eC__types__eInstance_New(__eCClass_Symbol);
...
__eCInstance1->name = __eCNameSpace__eC__types__CopyString(prop->name), __eCInstance1->isVirtual = 0, __eCInstance1->hasSet = prop->Set ? 1 : 0, __eCInstance1->hasGet = prop->Get ? 1 : 0, __eCInstance1;
});
if(classSym)
__eCMethod___eCNameSpace__eC__containers__OldList_Add(&classSym->_import->properties, symbol->_import);
}
imported = 1;
if((prop->_class->module != privateModule || !strcmp(prop->_class->name, "float") || !strcmp(prop->_class->name, "double")) && ((struct __eCNameSpace__eC__types__Module *)(((char *)prop->_class->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType != 1)
dllImport = 1;
}
if(!symbol->type)
{
...
instExternal = DeclareStruct((((void *)0)), "eC::types::Instance", 0, 1);
...
if(dllImport)
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*specifiers), (((void *)0)), MkSpecifier(EXTERN));
...
external = MkExternalDeclaration(decl);
if(structExternal)
__eCMethod_External_CreateEdge(external, structExternal, 0);
if(instExternal)
__eCMethod_External_CreateEdge(external, instExternal, 0);
if(spec)
...
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*specifiers), (((void *)0)), MkSpecifier(CONST));
...
{
if(symbol->__anon2.__anon2.externalPtr)
__eCMethod_External_CreateUniqueEdge(neededBy, symbol->__anon2.__anon2.externalPtr, 0);
if(symbol->__anon2.__anon2.externalGet)
__eCMethod_External_CreateUniqueEdge(neededBy, symbol->__anon2.__anon2.externalGet, symbol->__anon2.__anon2.externalGet->type == 0);
if(symbol->__anon2.__anon2.externalSet)
__eCMethod_External_CreateUniqueEdge(neededBy, symbol->__anon2.__anon2.externalSet, symbol->__anon2.__anon2.externalSet->type == 0);
}
}

static void ProcessDeclarator(struct Declarator *  decl, unsigned int isFunction);

void DeclareMethod(struct External * neededFor, struct __eCNameSpace__eC__types__Method * method, const char * name)
{
...
if(method->_class->module && ((struct __eCNameSpace__eC__types__Module *)(((char *)method->_class->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->name)
...
__eCInstance1->name = __eCNameSpace__eC__types__CopyString(method->_class->fullName), __eCInstance1->isRemote = method->_class->isRemote, __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__OldList_Add(&module->classes, classSym->_import);
}
if(!symbol)
{
symbol = method->symbol = __eCNameSpace__eC__types__eInstance_New(__eCClass_Symbol);
}
if(!symbol->_import)
{
symbol->_import = (struct ClassImport *)__extension__ ({
...
__eCInstance1->name = __eCNameSpace__eC__types__CopyString(method->name), __eCInstance1->isVirtual = method->type == 1, __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__OldList_Add(&classSym->_import->methods, symbol->_import);
}
if(!symbol)
{
...
{
if((method->_class->module != privateModule || !strcmp(method->_class->name, "float") || !strcmp(method->_class->name, "double")) && ((struct __eCNameSpace__eC__types__Module *)(((char *)method->_class->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType != 1)
dllImport = 1;
}
}
if(inCompiler)
...
if(funcDecl)
{
struct __eCNameSpace__eC__types__Class * _class = method->dataType->__anon1.__anon2.thisClass ? method->dataType->__anon1.__anon2.thisClass->__anon1.registered : method->_class;
...
__eCMethod___eCNameSpace__eC__containers__OldList_Remove((&*funcDecl->__anon1.function.parameters), param);
FreeTypeName(param);
}
if(!funcDecl->__anon1.function.parameters)
funcDecl->__anon1.function.parameters = MkList();
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*funcDecl->__anon1.function.parameters), (((void *)0)), thisParam);
}
}
}
...
__eCMethod_External_CreateUniqueEdge(neededFor, external, external->type == 0);
}
}
...
unsigned int DeclareFunction(struct External * neededFor, struct __eCNameSpace__eC__types__GlobalFunction * function, char * name)
{
...
symbol = function->symbol = __eCNameSpace__eC__types__eInstance_New(__eCClass_Symbol);
...
__eCInstance1->name = __eCNameSpace__eC__types__CopyString(function->name), __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__OldList_Add(&module->functions, symbol->_import);
}
}
{
...
if(imported && function->module != privateModule && ((struct __eCNameSpace__eC__types__Module *)(((char *)function->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType != 1)
dllImport = 1;
}
if(inCompiler)
{
...
if(((struct __eCNameSpace__eC__types__Module *)(((char *)function->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType == 1)
{
struct Specifier * spec;
...
{
funcDecl->__anon1.function.parameters = MkList();
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*funcDecl->__anon1.function.parameters), (((void *)0)), MkTypeName(MkListOne(MkSpecifier(VOID)), (((void *)0))));
}
ListAdd(declarators, MkInitDeclarator(d, (((void *)0))));
{
...
if(inCompiler && neededFor && symbol && symbol->__anon2.__anon1.pointerExternal)
__eCMethod_External_CreateUniqueEdge(neededFor, symbol->__anon2.__anon1.pointerExternal, symbol->__anon2.__anon1.pointerExternal->type == 0);
return (symbol && symbol->_import && function->module != privateModule && ((struct __eCNameSpace__eC__types__Module *)(((char *)function->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType != 1) ? 1 : 0;
}

void DeclareFunctionUtil(struct External * neededBy, const char * s)
{
struct __eCNameSpace__eC__types__GlobalFunction * function = __eCNameSpace__eC__types__eSystem_FindFunction(privateModule, s);
...
unsigned int ModuleVisibility(struct __eCNameSpace__eC__types__Instance * searchIn, struct __eCNameSpace__eC__types__Instance * searchFor)
{
...
{
if(subModule->importMode == 1 || searchIn == ((struct __eCNameSpace__eC__types__Module *)(((char *)searchIn + sizeof(struct __eCNameSpace__eC__types__Instance))))->application)
{
...
unsigned int MatchWithEnums_NameSpace(struct __eCNameSpace__eC__types__NameSpace * nameSpace, struct Expression * sourceExp, struct Type * dest, char * string, struct __eCNameSpace__eC__containers__OldList * conversions)
{
...
if(_class->type == 4)
{
struct __eCNameSpace__eC__containers__OldList converts =
{
0, 0, 0, 0, 0
};
...
sourceExp->__anon1.__anon1.constant = __eCNameSpace__eC__types__CopyString(constant);
}
while(converts.first)
{
struct Conversion * convert = converts.first;

__eCMethod___eCNameSpace__eC__containers__OldList_Remove(&converts, convert);
__eCMethod___eCNameSpace__eC__containers__OldList_Add(conversions, convert);
}
((type ? __extension__ ({
...
if(converts.first)
__eCMethod___eCNameSpace__eC__containers__OldList_Free(&converts, (void *)(FreeConvert));
((type ? __extension__ ({
void * __eCPtrToDelete = (type);
...
for(nameSpace = (struct __eCNameSpace__eC__types__NameSpace *)__eCProp___eCNameSpace__eC__containers__BinaryTree_Get_first(&nameSpace->nameSpaces); nameSpace != (((void *)0)); nameSpace = (struct __eCNameSpace__eC__types__NameSpace *)__eCProp___eCNameSpace__eC__containers__BTNode_Get_next(((struct __eCNameSpace__eC__containers__BTNode *)nameSpace)))
if(MatchWithEnums_NameSpace(nameSpace, sourceExp, dest, string, conversions))
return 1;
return 0;
}

unsigned int MatchWithEnums_Module(struct __eCNameSpace__eC__types__Instance * mainModule, struct Expression * sourceExp, struct Type * dest, char * string, struct __eCNameSpace__eC__containers__OldList * conversions)
{
struct __eCNameSpace__eC__types__Instance * module;

if(MatchWithEnums_NameSpace(&((struct __eCNameSpace__eC__types__Application *)(((char *)((struct __eCNameSpace__eC__types__Module *)(((char *)mainModule + sizeof(struct __eCNameSpace__eC__types__Instance))))->application + sizeof(struct __eCNameSpace__eC__types__Module) + sizeof(struct __eCNameSpace__eC__types__Instance))))->systemNameSpace, sourceExp, dest, string, conversions))
return 1;
if(MatchWithEnums_NameSpace(&((struct __eCNameSpace__eC__types__Module *)(((char *)((struct __eCNameSpace__eC__types__Module *)(((char *)mainModule + sizeof(struct __eCNameSpace__eC__types__Instance))))->application + sizeof(struct __eCNameSpace__eC__types__Instance))))->privateNameSpace, sourceExp, dest, string, conversions))
return 1;
if(MatchWithEnums_NameSpace(&((struct __eCNameSpace__eC__types__Module *)(((char *)((struct __eCNameSpace__eC__types__Module *)(((char *)mainModule + sizeof(struct __eCNameSpace__eC__types__Instance))))->application + sizeof(struct __eCNameSpace__eC__types__Instance))))->publicNameSpace, sourceExp, dest, string, conversions))
return 1;
...
{
if(ModuleVisibility(mainModule, module) && MatchWithEnums_NameSpace(&((struct __eCNameSpace__eC__types__Module *)(((char *)module + sizeof(struct __eCNameSpace__eC__types__Instance))))->publicNameSpace, sourceExp, dest, string, conversions))
return 1;
}
return 0;
}
...
void ComputeClassMembers(struct __eCNameSpace__eC__types__Class * _class, unsigned int isMember)
{
struct __eCNameSpace__eC__types__DataMember * member = isMember ? (struct __eCNameSpace__eC__types__DataMember *)_class : (((void *)0));
struct Context * context = isMember ? (((void *)0)) : SetupTemplatesContext(_class);
...
_class->memberOffset += sizeof(struct __eCNameSpace__eC__containers__OldList);
{
...
{
struct __eCNameSpace__eC__types__BitMember * bitMember = (struct __eCNameSpace__eC__types__BitMember *)dataMember;
uint64 mask = 0;
int d;
...
if(inPreCompiler)
{
struct __eCNameSpace__eC__types__Class * b = _class;
...
__eCNameSpace__eC__types__PrintLn(__eCClass_char__PTR_, "overflowing bits in ", __eCClass_char__PTR_, _class->name, __eCClass_char__PTR_, ": bit class member ", __eCClass_char__PTR_, bitMember->name, __eCClass_char__PTR_, " at position ", __eCClass_int, (void *)&bitMember->pos, (void *)0);
}
...
ComputeClassMembers((struct __eCNameSpace__eC__types__Class *)dataMember, 1);
...
{
struct __eCNameSpace__eC__types__Class * deriv = derivative->data;
...
int AddMembers(struct External * neededBy, struct __eCNameSpace__eC__containers__OldList * declarations, struct __eCNameSpace__eC__types__Class * _class, unsigned int isMember, unsigned int * retSize, struct __eCNameSpace__eC__types__Class * topClass, unsigned int * addedPadding)
{
struct __eCNameSpace__eC__types__DataMember * topMember = isMember ? (struct __eCNameSpace__eC__types__DataMember *)_class : (((void *)0));
...
case 2:
{
struct __eCNameSpace__eC__containers__OldList * specs = MkList(), * list = MkList();
char id[100];

sprintf(id, "__anon%d", anonID++);
size = 0;
AddMembers(neededBy, list, (struct __eCNameSpace__eC__types__Class *)member, 1, &size, topClass, (((void *)0)));
...
{
char sizeString[50];
char * paddingString = __eCNameSpace__eC__types__PrintString(__eCClass_char__PTR_, "__eC_padding", __eCClass_int, (void *)&paddingID, (void *)0);
...
if(addedPadding)
*addedPadding = 1;
(__eCNameSpace__eC__types__eSystem_Delete(paddingString), paddingString = 0);
totalSize = maxSize;
}
}
if(retSize)
...
{
struct __eCNameSpace__eC__types__Class * sourceBase, * destBase;
...
else if(source->__anon1._class && dest->__anon1._class && (dest->classObjectType == source->classObjectType || !dest->classObjectType) && (enumBaseType || (!source->__anon1._class->__anon1.registered || source->__anon1._class->__anon1.registered->type != 4) || (!dest->__anon1._class->__anon1.registered || dest->__anon1._class->__anon1.registered->type != 4)) && __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, dest->__anon1._class->__anon1.registered))
return 1;
else
{
...
{
if(__eCNameSpace__eC__types__eClass_IsDerived(dest->__anon1._class->__anon1.registered, source->__anon1._class->__anon1.registered))
{
return 1;
}
}
...
{
if(!strcmp(dest->__anon1._class->__anon1.registered->templateClass->name, "Map") && __eCNameSpace__eC__types__eClass_IsDerived(dest->__anon1._class->__anon1.registered->templateClass, source->__anon1._class->__anon1.registered->templateClass))
{
...
char * sb = __eCNameSpace__eC__types__RSearchString(sourceName, ">", strlen(sourceName), 0, 0);
...
if(source->kind == 19 && dest->kind == 8 && dest->__anon1._class && !strcmp(dest->__anon1._class->string, "eC::types::Class"))
return 1;
if(doConversion)
{
if(source->kind == 8)
...
{
struct Conversion * conv = (conv = __eCNameSpace__eC__types__eInstance_New(__eCClass_Conversion), conv->convert = convert, conv->isGet = 1, conv);

__eCMethod___eCNameSpace__eC__containers__OldList_Insert(conversions, after, conv);
return 1;
}
}
}
...
{
struct Type * ptrType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);

constType = __extension__ ({
struct Type * __eCInstance1 = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);

__eCInstance1->kind = 13, __eCInstance1->refCount = 1, __eCInstance1->__anon1.type = ptrType, __eCInstance1;
});
...
{
struct Conversion * conv = (conv = __eCNameSpace__eC__types__eInstance_New(__eCClass_Conversion), conv->convert = convert, conv);

__eCMethod___eCNameSpace__eC__containers__OldList_Add(conversions, conv);
success = 1;
}
}
}
...
return 1;
else if(dest->kind == 27 && (source->kind == 6 || source->kind == 7))
return 1;
else if(dest->kind == 28 && (source->kind == 6 || source->kind == 7))
return 1;
...
if(curParam)
{
struct __eCNameSpace__eC__types__ClassTemplateArgument arg = owningClassSource->templateArgs[id];
...
e->destType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
{
struct Expression * operand = __eCNameSpace__eC__types__eInstance_New(__eCClass_Expression);

*operand = *checkedExp;
__eCMethod_Expression_Clear(checkedExp);
...
{
struct Expression * thisExp = __eCNameSpace__eC__types__eInstance_New(__eCClass_Expression);

*thisExp = *e;
thisExp->prev = (((void *)0));
thisExp->next = (((void *)0));
__eCMethod_Expression_Clear(e);
e->type = 5;
...
{
e->expType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
t = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
struct __eCNameSpace__eC__containers__OldList * curDeclarations = (((void *)0));
...
_DeclareStruct(neededBy, "eC::types::Instance", 0, 1, fwdDecl);
...
{
struct __eCNameSpace__eC__containers__OldList * specifiers, * declarators;
struct __eCNameSpace__eC__containers__OldList * declarations = (((void *)0));
...
if(((struct __eCNameSpace__eC__containers__LinkList *)(((char *)e->incoming + 0 + sizeof(struct __eCNameSpace__eC__types__Instance))))->count)
__eCMethod_External_CreateUniqueEdge(neededBy, e, !needDereference && !external->fwdDecl);
}
else
__eCMethod_External_CreateUniqueEdge(neededBy, external, !needDereference);
}
return external;
}
...
static void ReplaceClassMembers(struct Expression * exp, struct __eCNameSpace__eC__types__Class * _class)
{
...
if(!ctx)
break;
symbol = (struct Symbol *)__eCMethod___eCNameSpace__eC__containers__BinaryTree_FindString(&ctx->symbols, id->string);
if(symbol)
break;
}
}
if(!symbol && ((!id->_class || (id->_class->__anon1.__anon1.name && !strcmp(id->_class->__anon1.__anon1.name, "property"))) || (id->classSym && __eCNameSpace__eC__types__eClass_IsDerived(_class, id->classSym->__anon1.registered))))
{
struct __eCNameSpace__eC__types__Property * prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, id->string, privateModule);
struct __eCNameSpace__eC__types__Method * method = (((void *)0));
struct __eCNameSpace__eC__types__DataMember * member = (((void *)0));
struct __eCNameSpace__eC__types__ClassProperty * classProp = (((void *)0));
...
if(!prop)
{
method = __eCNameSpace__eC__types__eClass_FindMethod(_class, id->string, privateModule);
}
if(!prop && !method)
member = __eCNameSpace__eC__types__eClass_FindDataMember(_class, id->string, privateModule, (((void *)0)), (((void *)0)));
if(!prop && !method && !member)
{
classProp = __eCNameSpace__eC__types__eClass_FindClassProperty(_class, id->string);
}
...
{
type->__anon1.__anon4.arraySize = (int)__eCNameSpace__eC__types__eClass_GetProperty(type->__anon1.__anon4.enumClass->__anon1.registered, "enumSize");
}
else
...
unsigned int MatchTypeExpression(struct Expression * sourceExp, struct Type * dest, struct __eCNameSpace__eC__containers__OldList * conversions, unsigned int skipUnitBla, unsigned int warnConst)
{
struct Type * source;
...
__eCInstance1->kind = 3, __eCInstance1->isSigned = 0, __eCInstance1->refCount = 1, __eCInstance1;
});
}
if(dest->kind == 8)
{
struct __eCNameSpace__eC__types__Class * _class = dest->__anon1._class ? dest->__anon1._class->__anon1.registered : (((void *)0));

if(_class && _class->type == 3)
{
if(source->kind != 8)
{
struct Type * tempType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
{
sourceExp->expType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
if(_class && !strcmp(_class->fullName, "eC::types::Class") && source->kind == 13 && source->__anon1.type && source->__anon1.type->kind == 1 && sourceExp->type == 3)
{
struct __eCNameSpace__eC__containers__OldList * specs = MkList();
struct Declarator * decl;
char string[1024];
...
{
struct __eCNameSpace__eC__types__Class * _class = source->__anon1._class ? source->__anon1._class->__anon1.registered : (((void *)0));
...
{
struct __eCNameSpace__eC__types__Class * enumClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "enum");
struct __eCNameSpace__eC__types__EnumClassData * c = (_class ? ((void *)(((char *)_class->data) + enumClass->offsetClass)) : (((void *)0)));
...
{
struct __eCNameSpace__eC__types__Class * _class = dest->__anon1._class->__anon1.registered;
struct __eCNameSpace__eC__types__Class * enumClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "enum");
...
id->string = __eCNameSpace__eC__types__PrintString(__eCClass_char__PTR_, _class->name, __eCClass_char__PTR_, "_", __eCClass_char__PTR_, value->name, (void *)0);
}
FreeType(dest);
return 1;
}
...
static void PopulateInstanceProcessMember(struct Instantiation * inst, struct __eCNameSpace__eC__containers__OldList * memberList, struct __eCNameSpace__eC__types__DataMember * parentDataMember, unsigned int offset)
{
struct __eCNameSpace__eC__types__DataMember * dataMember;
...
{
struct Expression * exp = __eCNameSpace__eC__types__eInstance_New(__eCClass_Expression);
...
if(type->kind == 8)
{
struct __eCNameSpace__eC__types__Class * _class = type->__anon1._class->__anon1.registered;
...
{
struct __eCNameSpace__eC__types__Class * c = exp->expType->__anon1._class->__anon1.registered;
...
{
struct __eCNameSpace__eC__containers__OldList * specs;
struct __eCNameSpace__eC__containers__OldList * unionDefs = MkList();
...
if((exp->expType->kind == 8 && exp->expType->__anon1._class && exp->expType->__anon1._class->__anon1.registered && exp->expType->__anon1._class->__anon1.registered->type == 1) || __eCProp_Type_Get_isPointerType(exp->expType))
...
static void CreateFireWatcher(struct __eCNameSpace__eC__types__Property * prop, struct Expression * object, struct Statement * stmt)
{
...
ListAdd(stmt->__anon1.expressions, MkExpCall(MkExpIdentifier(MkIdentifier("eC::types::eInstance_FireWatchers")), args));
args = MkList();
ListAdd(args, object ? CopyExpression(object) : MkExpIdentifier(MkIdentifier("this")));
...
ListAdd(args, object ? CopyExpression(object) : MkExpIdentifier(MkIdentifier("this")));
ListAdd(args, MkExpIdentifier(MkIdentifier(propName)));
ListAdd(stmt->__anon1.expressions, MkExpCondition(MkExpOp(MkExpIdentifier(MkIdentifier(propName)), AND_OP, MkExpMember(MkExpIdentifier(MkIdentifier(propName)), MkIdentifier("selfWatchable"))), MkListOne(MkExpCall(MkExpIdentifier(MkIdentifier("eC::types::eInstance_FireSelfWatchers")), args)), MkExpCast(MkTypeName(MkListOne(MkSpecifier(VOID)), (((void *)0))), MkExpConstant("0"))));
ProcessExpressionType((*stmt->__anon1.expressions).last);
args = MkList();
ListAdd(args, object ? CopyExpression(object) : MkExpIdentifier(MkIdentifier("this")));
ListAdd(args, MkExpIdentifier(MkIdentifier(propNameM)));
ListAdd(stmt->__anon1.expressions, MkExpCondition(MkExpOp(MkExpIdentifier(MkIdentifier(propNameM)), AND_OP, MkExpMember(MkExpIdentifier(MkIdentifier(propNameM)), MkIdentifier("selfWatchable"))), MkListOne(MkExpCall(MkExpIdentifier(MkIdentifier("eC::types::eInstance_FireSelfWatchers")), args)), MkExpCast(MkTypeName(MkListOne(MkSpecifier(VOID)), (((void *)0))), MkExpConstant("0"))));
ProcessExpressionType((*stmt->__anon1.expressions).last);
...
{
exp->__anon1.member.exp->expType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
struct __eCNameSpace__eC__types__DataMember * dataMember;
struct __eCNameSpace__eC__containers__OldList * memberList = MkList();

if(!inst->members)
inst->members = MkListOne(MkMembersInitList(memberList));
else
__eCMethod___eCNameSpace__eC__containers__OldList_Add((&*inst->members), MkMembersInitList(memberList));
...
void ProcessMemberInitData(struct MemberInit * member, struct __eCNameSpace__eC__types__Class * _class, struct __eCNameSpace__eC__types__Class ** curClass, struct __eCNameSpace__eC__types__DataMember ** curMember, struct __eCNameSpace__eC__types__DataMember ** subMemberStack, int * subMemberStackPos)
{
...
{
struct __eCNameSpace__eC__types__DataMember * thisMember = (struct __eCNameSpace__eC__types__DataMember *)__eCNameSpace__eC__types__eClass_FindProperty(_class, ident->string, privateModule);
struct __eCNameSpace__eC__types__DataMember * _subMemberStack[256];
int _subMemberStackPos = 0;

if(!thisMember)
thisMember = __eCNameSpace__eC__types__eClass_FindDataMember(_class, ident->string, privateModule, _subMemberStack, &_subMemberStackPos);
if(thisMember)
{
...
{
method = __eCNameSpace__eC__types__eClass_FindMethod(_class, ident->string, privateModule);
...
if(type->kind == 8)
{
dataMember = (struct __eCNameSpace__eC__types__DataMember *)__eCNameSpace__eC__types__eClass_FindProperty(type->__anon1._class->__anon1.registered, ident->string, privateModule);
if(!dataMember)
dataMember = __eCNameSpace__eC__types__eClass_FindDataMember(type->__anon1._class->__anon1.registered, ident->string, privateModule, (((void *)0)), (((void *)0)));
if(dataMember)
type = dataMember->dataType;
}
else if(type->kind == 9 || type->kind == 10)
...
if(curParam)
{
struct __eCNameSpace__eC__types__ClassTemplateArgument arg = _class->templateArgs[id];
...
{
struct __eCNameSpace__eC__types__Class * expClass = type->__anon1._class->__anon1.registered;
...
if(_class->type == 0 || _class->type == 5)
{
inst->data = (unsigned char *)__eCNameSpace__eC__types__eInstance_New(_class);
if(_class->type == 0)
((struct __eCNameSpace__eC__types__Instance *)(char *)((struct __eCNameSpace__eC__types__Instance *)inst->data))->_refCount++;
}
else
inst->data = __eCNameSpace__eC__types__eSystem_New0(sizeof(unsigned char) * (_class->structSize));
}
if(inst->members)
{
for(members = (*inst->members).first; members; members = members->next)
...
prop = (struct __eCNameSpace__eC__types__Property *)curMember;
else
{
dataMember = curMember;
__eCNameSpace__eC__types__eClass_FindDataMemberAndOffset(_class, dataMember->name, &dataMemberOffset, privateModule, (((void *)0)), (((void *)0)));
...
{
prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, ident->string, privateModule);
if(prop)
{
found = 1;
if(prop->memberAccess == 1)
{
curMember = (struct __eCNameSpace__eC__types__DataMember *)prop;
...
dataMember = __eCNameSpace__eC__types__eClass_FindDataMemberAndOffset(_class, ident->string, &dataMemberOffset, privateModule, _subMemberStack, &_subMemberStackPos);
if(dataMember)
{
if(dataMember->_class->type == 0 || dataMember->_class->type == 5)
dataMemberOffset += dataMember->_class->base->structSize;
...
if(type->kind == 8)
{
prop = __eCNameSpace__eC__types__eClass_FindProperty(type->__anon1._class->__anon1.registered, ident->string, privateModule);
if(prop)
type = prop->dataType;
else
{
dataMember = __eCNameSpace__eC__types__eClass_FindDataMemberAndOffset(type->__anon1._class->__anon1.registered, ident->string, &dataMemberOffset, privateModule, (((void *)0)), (((void *)0)));
if(dataMember)
{
if(dataMember->_class->type == 0 || dataMember->_class->type == 5)
dataMemberOffset += dataMember->_class->base->structSize;
...
if(_class && (_class->type != 0 || __eCNameSpace__eC__types__eClass_IsDerived(((struct __eCNameSpace__eC__types__Instance *)(char *)((struct __eCNameSpace__eC__types__Instance *)value->__anon1.instance->data))->_class, _class)))
{
...
Set(inst->data, __eCNameSpace__eC__types___strtoi64(value->__anon1.__anon1.constant, (((void *)0)), 0));
break;
}
case 22:
{
...
Set(inst->data, (intptr_t)__eCNameSpace__eC__types___strtoi64(value->__anon1.__anon1.constant, (((void *)0)), 0));
break;
}
case 23:
{
...
Set(inst->data, (ssize_t)__eCNameSpace__eC__types___strtoi64(value->__anon1.__anon1.constant, (((void *)0)), 0));
break;
}
}
}
...
{
struct __eCNameSpace__eC__types__Class * c = (exp->expType && exp->expType->kind == 8 && exp->expType->__anon1._class) ? exp->expType->__anon1._class->__anon1.registered : (((void *)0));
...
int len = strlen(string);
char * tmp = __eCNameSpace__eC__types__eSystem_New(sizeof(char) * (len - 2 + 1));

len = UnescapeString(tmp, string + 1, len - 2);
(__eCNameSpace__eC__types__eSystem_Delete(tmp), tmp = 0);
FreeExpContents(exp);
exp->type = 2;
...
if(!n)
{
struct __eCNameSpace__eC__containers__OldList * list = exp->__anon1.list;
...
if(type)
{
struct __eCNameSpace__eC__types__Class * _class = (exp->__anon1.member.member && exp->__anon1.member.member->classSym) ? exp->__anon1.member.member->classSym->__anon1.registered : (((type->kind == 8 || type->kind == 19) && type->__anon1._class) ? type->__anon1._class->__anon1.registered : (((void *)0)));
struct __eCNameSpace__eC__types__Property * prop = (((void *)0));
struct __eCNameSpace__eC__types__DataMember * member = (((void *)0));
...
case 8:
{
struct __eCNameSpace__eC__types__Class * propertyClass = type->__anon1._class->__anon1.registered;

if(propertyClass->type == 1 && value->type == 1)
{
void (* Set)(void *, void *) = (void *)prop->Set;

exp->__anon1.instance = __eCNameSpace__eC__types__eInstance_New(__eCClass_Instantiation);
exp->__anon1.instance->data = __eCNameSpace__eC__types__eSystem_New0(sizeof(unsigned char) * (_class->structSize));
...
strcat(name, number);
nameID->string = __eCNameSpace__eC__types__CopyString(name);
}
if(declarator)
{
struct Symbol * symbol = declarator->symbol;
struct __eCNameSpace__eC__types__Method * method = __eCNameSpace__eC__types__eClass_FindMethod(_class, unmangled, privateModule);
...
if(!symbol->type->__anon1.__anon2.thisClass)
{
if(method->dataType->__anon1.__anon2.thisClass && currentClass && __eCNameSpace__eC__types__eClass_IsDerived(currentClass, method->dataType->__anon1.__anon2.thisClass->__anon1.registered))
{
...
(__eCNameSpace__eC__types__eSystem_Delete(unmangled), unmangled = 0);
}
break;
}
case 0:
...
static void ProcessClass(struct __eCNameSpace__eC__containers__OldList *  definitions, struct Symbol *  symbol);
...
{
struct __eCNameSpace__eC__types__Class * c = spec->__anon1.__anon1.symbol->__anon1.registered;
...
if(classSpec)
{
struct TypeName * param = (param = __eCNameSpace__eC__types__eInstance_New(__eCClass_TypeName), param->qualifiers = MkListOne(classSpec), param->declarator = (((void *)0)), param);

if(!decl->__anon1.function.parameters)
decl->__anon1.function.parameters = MkList();
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*decl->__anon1.function.parameters), (((void *)0)), param);
}
if(decl->__anon1.function.parameters)
{
...
struct TypeName * newParam = (newParam = __eCNameSpace__eC__types__eInstance_New(__eCClass_TypeName), newParam->qualifiers = MkListOne(MkSpecifier(VOID)), newParam->declarator = MkDeclaratorPointer(MkPointer((((void *)0)), (((void *)0))), d), newParam);

if(!d || d->type != 5)
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*newParam->qualifiers), (((void *)0)), MkSpecifier(CONST));
FreeList(param->qualifiers, (void *)(FreeSpecifier));
param->qualifiers = MkListOne(MkStructOrUnion(3, MkIdentifier("__eCNameSpace__eC__types__Class"), (((void *)0))));
...
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*decl->__anon1.function.parameters), param, newParam);
param = newParam;
break;
}
...
struct __eCNameSpace__eC__containers__OldList * exp = stmt->__anon1.forEachStmt.exp;
struct __eCNameSpace__eC__containers__OldList * filter = stmt->__anon1.forEachStmt.filter;
...
if(isBuiltin || (source && source->kind == 8 && source->__anon1._class && source->__anon1._class->__anon1.registered && source->__anon1._class->__anon1.registered != containerClass && __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, containerClass)))
{
struct __eCNameSpace__eC__types__Class * _class = source ? source->__anon1._class->__anon1.registered : (((void *)0));
struct Symbol * symbol;
...
struct __eCNameSpace__eC__types__Class * linkListClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "LinkList");
struct __eCNameSpace__eC__types__Class * customAVLTreeClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "CustomAVLTree");

if(inCompiler)
{
stmt->type = 2;
stmt->__anon1.compound.context = __eCNameSpace__eC__types__eInstance_New(__eCClass_Context);
stmt->__anon1.compound.context->parent = curContext;
curContext = stmt->__anon1.compound.context;
}
if(source && __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, customAVLTreeClass))
{
struct __eCNameSpace__eC__types__Class * mapClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "Map");

isCustomAVLTree = 1;
if(__eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, mapClass))
isMap = 1;
}
else if(source && __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, arrayClass))
isArray = 1;
else if(source && __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, linkListClass))
{
struct __eCNameSpace__eC__types__Class * listClass = __eCNameSpace__eC__types__eSystem_FindClass(privateModule, "List");

isLinkList = 1;
isList = __eCNameSpace__eC__types__eClass_IsDerived(source->__anon1._class->__anon1.registered, listClass);
}
...
if(arrayExp->destType && arrayExp->destType->kind == 8 && arrayExp->destType->__anon1._class && arrayExp->destType->__anon1._class->__anon1.registered && arrayExp->destType->__anon1._class->__anon1.registered != containerClass && __eCNameSpace__eC__types__eClass_IsDerived(arrayExp->destType->__anon1._class->__anon1.registered, containerClass) && arrayExp->destType->__anon1._class->__anon1.registered->templateArgs)
{
struct __eCNameSpace__eC__types__Class * templateClass = arrayExp->destType->__anon1._class->__anon1.registered;
...
if(inCompiler)
{
struct __eCNameSpace__eC__containers__OldList * initializers = MkList();
struct Declarator * decl;
struct __eCNameSpace__eC__containers__OldList * specs = MkList();
...
{
__eCMethod___eCNameSpace__eC__containers__OldList_Remove((&*arrayExp->__anon1.list), e);
e->destType = type;
type->refCount++;
ProcessExpressionType(e);
if(inCompiler)
...
FreeType(type);
(__eCNameSpace__eC__types__eSystem_Delete(arrayExp->__anon1.list), arrayExp->__anon1.list = 0);
}
...
{
struct __eCNameSpace__eC__types__Class * typeClass = __eCNameSpace__eC__types__eSystem_FindClass(_class->module, _class->templateArgs[3].__anon1.__anon1.dataTypeString);
struct __eCNameSpace__eC__types__Class * listItemClass = __eCNameSpace__eC__types__eSystem_FindClass(_class->module, "ListItem");

if(typeClass && __eCNameSpace__eC__types__eClass_IsDerived(typeClass, listItemClass) && _class->templateArgs[5].__anon1.__anon1.dataTypeString && !strcmp(_class->templateArgs[5].__anon1.__anon1.dataTypeString, "LT::link"))
{
...
struct __eCNameSpace__eC__containers__OldList * watches = stmt->__anon1._watch.watches;
...
ListAdd(stmt->__anon1.expressions, MkExpCall(MkExpIdentifier(MkIdentifier("eC::types::eInstance_WatchDestruction")), args));
}
else
{
struct __eCNameSpace__eC__types__Class * _class = object->expType->__anon1._class->__anon1.registered;
struct Identifier * propID;

for(propID = (*propWatch->properties).first; propID; propID = propID->next)
{
char propName[1024];
struct __eCNameSpace__eC__types__Property * prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, propID->string, privateModule);
...
ListAdd(stmt->__anon1.expressions, MkExpCall(MkExpIdentifier(MkIdentifier("eC::types::eInstance_Watch")), args));
...
currentClass = (((void *)0));
containerClass = __eCNameSpace__eC__types__eSystem_FindClass(GetPrivateModule(), "Container");
DeclareStruct((((void *)0)), "eC::types::Class", 0, 1);
DeclareStruct((((void *)0)), "eC::types::Instance", 0, 1);
DeclareStruct((((void *)0)), "eC::types::Property", 0, 1);
DeclareStruct((((void *)0)), "eC::types::DataMember", 0, 1);
DeclareStruct((((void *)0)), "eC::types::Method", 0, 1);
DeclareStruct((((void *)0)), "eC::types::SerialBuffer", 0, 1);
DeclareStruct((((void *)0)), "eC::types::ClassTemplateArgument", 0, 1);
...
{
exp->expType = ProcessTypeString("eC::types::Platform", 1);
break;
}
else if(strstr(id->string, "__eCClass") == id->string)
{
exp->expType = ProcessTypeString("eC::types::Class", 1);
break;
}
...
struct __eCNameSpace__eC__types__Class * _class = (type && type->kind == 8 && type->__anon1._class) ? type->__anon1._class->__anon1.registered : (((void *)0));
...
id->_class = (((void *)0));
(__eCNameSpace__eC__types__eSystem_Delete(id->string), id->string = 0);
id->string = __eCNameSpace__eC__types__CopyString(symbol->string);
id->classSym = (((void *)0));
exp->expType = type;
if(type)
type->refCount++;
...
{
struct __eCNameSpace__eC__types__DefinedExpression * definedExp = (((void *)0));
...
definedExp = __eCNameSpace__eC__types__eSystem_FindDefine(privateModule, name);
}
if(!definedExp)
definedExp = __eCNameSpace__eC__types__eSystem_FindDefine(privateModule, id->string);
if(definedExp)
{
if(!inBGen)
{
...
struct __eCNameSpace__eC__types__Instance * backInput = fileInput;
...
(__eCNameSpace__eC__types__eSystem_Delete(id->string), id->string = 0);
id->string = __eCNameSpace__eC__types__CopyString(data->fullName);
FreeSpecifier(id->_class);
id->_class = (((void *)0));
break;
}
...
{
struct __eCNameSpace__eC__types__GlobalFunction * function = (((void *)0));
...
strcat(name, "::");
strcat(name, id->string);
function = __eCNameSpace__eC__types__eSystem_FindFunction(privateModule, name);
}
if(!function)
function = __eCNameSpace__eC__types__eSystem_FindFunction(privateModule, id->string);
if(function)
{
char name[1024];

(__eCNameSpace__eC__types__eSystem_Delete(id->string), id->string = 0);
id->string = __eCNameSpace__eC__types__CopyString(function->name);
name[0] = 0;
if(((struct __eCNameSpace__eC__types__Module *)(((char *)function->module + sizeof(struct __eCNameSpace__eC__types__Instance))))->importType != 1 && (!function->dataType || !function->dataType->dllExport))
strcpy(name, "__eCFunction_");
...
struct Type * type = (type = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type), type->refCount = 1, type->constant = 1, type);
...
{
int nb;
unsigned int ch = __eCNameSpace__eC__i18n__UTF8GetChar(constant + 1, &nb);

if(nb < 2)
ch = constant[1];
(__eCNameSpace__eC__types__eSystem_Delete(constant), constant = 0);
...
exp->isConstant = 1;
exp->expType = __extension__ ({
struct Type * __eCInstance2 = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);

__eCInstance2->refCount = 1, __eCInstance2->kind = 13, __eCInstance2->__anon1.type = __extension__ ({
struct Type * __eCInstance1 = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);

__eCInstance1->refCount = 1, __eCInstance1->kind = exp->__anon1.__anon2.wideString ? 2 : 1, __eCInstance1->constant = 1, __eCInstance1->isSigned = exp->__anon1.__anon2.wideString ? 0 : 1, __eCInstance1;
}), __eCInstance2;
});
break;
}
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 13, __eCInstance1->__anon1.type = ProcessType(exp->__anon1._new.typeName->qualifiers, exp->__anon1._new.typeName->declarator), __eCInstance1;
});
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 13, __eCInstance1->__anon1.type = ProcessType(exp->__anon1._renew.typeName->qualifiers, exp->__anon1._renew.typeName->declarator), __eCInstance1;
});
DeclareType(curExternal, exp->expType->__anon1.type, 1, 0);
break;
case 4:
...
struct __eCNameSpace__eC__types__Class * destClass = (exp->destType && exp->destType->kind == 8 && exp->destType->__anon1._class) ? exp->destType->__anon1._class->__anon1.registered : (((void *)0));
unsigned int powerOp = 0, relationOp = 0;
struct __eCNameSpace__eC__types__Class * c1 = (((void *)0)), * c2 = (((void *)0));
struct Type * dummy = (dummy = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type), dummy->count = 1, dummy->refCount = 1, dummy);
...
{
type2 = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
type2->refCount = 1;
...
__eCInstance1->kind = 3, __eCInstance1;
});
type2->refCount = 1;
type2->isSigned = 1;
}
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 23, __eCInstance1;
});
exp->isConstant = 1;
}
...
__eCNameSpace__eC__types__ChangeCh(expString1, '\n', ' ');
PrintExpression(exp->__anon1.op.exp2, expString2);
__eCNameSpace__eC__types__ChangeCh(expString2, '\n', ' ');
...
struct __eCNameSpace__eC__types__Class * c = _class->templateClass ? _class->templateClass : _class;

if(_class != containerClass && __eCNameSpace__eC__types__eClass_IsDerived(c, containerClass) && _class->templateArgs)
{
...
if(a)
{
__eCMethod___eCNameSpace__eC__containers__OldList_Clear((&*exp->__anon1.call.arguments));
...
{
struct __eCNameSpace__eC__containers__OldList * specs = MkList();
struct __eCNameSpace__eC__containers__OldList * decls = MkList();
struct Declaration * decl;
...
struct __eCNameSpace__eC__types__Class * _class = methodType->__anon1.__anon3.usedClass;
struct __eCNameSpace__eC__types__ClassTemplateParameter * curParam = (((void *)0));
int id = 0;
...
__eCInstance1->refCount = 0, __eCInstance1->kind = 11, __eCInstance1;
});
if(exp->__anon1.call.exp->type == 0)
{
...
__eCInstance1->string = __eCNameSpace__eC__types__CopyString(string), __eCInstance1->type = ProcessTypeString("int()", 1), __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&globalContext->symbols, (struct __eCNameSpace__eC__containers__BTNode *)symbol);
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 3, __eCInstance1;
});
}
}
if(functionType && functionType->kind == 11)
...
{
struct __eCNameSpace__eC__types__Class * _class = thisClass ? thisClass : currentClass;
struct __eCNameSpace__eC__types__ClassTemplateParameter * param = (((void *)0));
...
{
struct __eCNameSpace__eC__types__Class * expClass = exp->expType->__anon1._class->__anon1.registered;
struct __eCNameSpace__eC__types__Class * cClass = (((void *)0));
int paramCount = 0;
int lastParam = -1;
char templateString[1024];
...
if(!__eCProp_Type_Get_isPointerType(expMember->expType))
...
struct __eCNameSpace__eC__types__Class * _class = (id && (!id->_class || id->_class->__anon1.__anon1.name)) ? (id->classSym ? id->classSym->__anon1.registered : (type->__anon1._class ? type->__anon1._class->__anon1.registered : (((void *)0)))) : (((void *)0));
...
{
prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, id->string, privateModule);
if(prop)
member = (((void *)0));
}
if(!member && !prop)
...
if(!id->classSym)
{
prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, id->string, (((void *)0)));
...
member = __eCNameSpace__eC__types__eClass_FindDataMember(_class, id->string, (((void *)0)), (((void *)0)), (((void *)0)));
}
if((!prop || useMemberForNonConst) && !member)
{
method = useMemberForNonConst ? (((void *)0)) : __eCNameSpace__eC__types__eClass_FindMethod(_class, id->string, (((void *)0)));
if(!method)
{
prop = __eCNameSpace__eC__types__eClass_FindProperty(_class, id->string, privateModule);
useMemberForNonConst |= prop && exp->destType && ((exp->destType->kind == 8 && !exp->destType->constant) || ((exp->destType->kind == 13 || exp->destType->kind == 12) && exp->destType->__anon1.type && !exp->destType->__anon1.type->constant)) && !strncmp(prop->dataTypeString, "const ", 6);
...
if(member && prop)
{
if(useMemberForNonConst || (member->_class != prop->_class && !id->_class && __eCNameSpace__eC__types__eClass_IsDerived(member->_class, prop->_class)))
prop = (((void *)0));
else
member = (((void *)0));
}
...
if(typeKind == 19)
{
classProp = __eCNameSpace__eC__types__eClass_FindClassProperty(type->__anon1._class->__anon1.registered, exp->__anon1.member.member->string);
if(classProp)
{
...
classExp->expType = ProcessTypeString("eC::types::Class", 0);
strcpy(structName, "__eCClassData_");
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 8, __eCInstance1->__anon1._class = prop ? prop->_class->symbol : method ? method->_class->symbol : _class->symbol, __eCInstance1->thisClassFrom = type ? type->thisClassFrom : (((void *)0)), __eCInstance1;
});
}
if(prop)
{
...
member->dataType->bitMemberSize = ((struct __eCNameSpace__eC__types__BitMember *)member)->size;
exp->expType = member->dataType;
if(member->dataType)
member->dataType->refCount++;
}
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 16, __eCInstance1->__anon1.__anon3.method = method, __eCInstance1;
});
...
exp->__anon1.__anon1.identifier = MkIdentifier("class");
FreeType(exp->expType);
exp->expType = MkClassType("eC::types::Class");
return ;
}
...
{
struct __eCNameSpace__eC__types__ClassTemplateArgument arg = tClass->templateArgs[id];
...
struct __eCNameSpace__eC__types__Class * thisClassFrom = (((void *)0));
...
thisClassFrom = __eCNameSpace__eC__types__eSystem_FindClass(GetPrivateModule(), "class");
FreeType(t);
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 13, __eCInstance1->__anon1.type = basicType, __eCInstance1;
});
if(!exp->destType)
{
...
for(param = cClass->templateParams.first; param; param = param->next)
{
struct __eCNameSpace__eC__types__Class * cClassCur = (((void *)0));
int cp = 0;
struct __eCNameSpace__eC__types__ClassTemplateParameter * paramCur = (((void *)0));
struct __eCNameSpace__eC__types__ClassTemplateArgument arg;

while(cClassCur != tClass && !paramCur)
{
struct __eCNameSpace__eC__types__Class * sClassCur;
...
{
char name[1024];
struct __eCNameSpace__eC__types__Class * b = classSym->__anon1.registered;
...
if(exp->destType && exp->destType->kind == 8 && exp->destType->__anon1._class && exp->destType->__anon1._class->__anon1.registered && exp->destType->__anon1._class->__anon1.registered != containerClass && __eCNameSpace__eC__types__eClass_IsDerived(exp->destType->__anon1._class->__anon1.registered, containerClass))
{
struct __eCNameSpace__eC__types__Class * templateClass = exp->destType->__anon1._class->__anon1.registered;
...
struct __eCNameSpace__eC__containers__OldList * initializers = MkList();
struct __eCNameSpace__eC__containers__OldList * structInitializers = MkList();
struct __eCNameSpace__eC__containers__OldList * specs = MkList();
...
{
__eCMethod___eCNameSpace__eC__containers__OldList_Remove((&*exp->__anon1.list), e);
e->destType = type;
type->refCount++;
ProcessExpressionType(e);
ListAdd(initializers, MkInitializerAssignment(e));
...
DeclareStruct(curExternal, "eC::containers::BuiltInContainer", 0, 1);
...
__eCInstance1->type = 2, __eCInstance1->__anon1.__anon1.constant = __eCNameSpace__eC__types__PrintString(__eCClass_int, (void *)&(*initializers).count, (void *)0), __eCInstance1;
})));
ProcessExpressionType(((struct Initializer *)(*structInitializers).last)->__anon1.exp);
...
{
struct Type * member;
char * enumName = __eCNameSpace__eC__types__CopyString(exp->expType->__anon1.__anon1.enumName);

FreeType(exp->expType);
exp->expType = __eCNameSpace__eC__types__eInstance_New(__eCClass_Type);
...
{
struct __eCNameSpace__eC__types__Class * c1 = (exp->expType->kind == 8 && exp->expType->__anon1._class) ? exp->expType->__anon1._class->__anon1.registered : (((void *)0));
struct __eCNameSpace__eC__types__Class * c2 = (exp->destType->kind == 8 && exp->destType->__anon1._class) ? exp->destType->__anon1._class->__anon1.registered : (((void *)0));

if(c1 && c1->type != 1)
c1 = (((void *)0));
if(c2 && c2->type != 1)
c2 = (((void *)0));
if((c1 && !exp->expType->byReference && !c2 && !__eCProp_Type_Get_isPointerType(exp->destType)) || (c2 && !exp->destType->byReference && !c1 && !__eCProp_Type_Get_isPointerType(exp->expType)))
invalidCast = 1;
}
...
struct __eCNameSpace__eC__types__Class * oldThisClass = thisClass;
...
struct __eCNameSpace__eC__types__Class * _class = type->__anon1.__anon2.thisClass->__anon1.registered;
char className[1024];
char structName[1024];
struct Declarator * funcDecl;
...
__eCMethod___eCNameSpace__eC__containers__OldList_Remove(&symbol->type->__anon1.__anon2.params, param);
FreeType(param);
}
if(type->classObjectType != 1)
{
__eCMethod___eCNameSpace__eC__containers__OldList_Insert(&symbol->type->__anon1.__anon2.params, (((void *)0)), MkClassType(_class->fullName));
symbol->type->__anon1.__anon2.staticMethod = 1;
...
__eCInstance1->declarator = MkDeclaratorPointer(MkPointer((((void *)0)), (((void *)0))), MkDeclaratorIdentifier(MkIdentifier("class"))), __eCInstance1->qualifiers = MkListOne(MkStructOrUnion(3, MkIdentifier("__eCNameSpace__eC__types__Class"), (((void *)0)))), __eCInstance1;
});
DeclareStruct(curExternal, "eC::types::Class", 0, 1);
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*funcDecl->__anon1.function.parameters), (((void *)0)), thisParam);
}
...
__eCInstance1->string = __eCNameSpace__eC__types__CopyString("this"), __eCInstance1->type = classSym ? MkClassType(classSym->string) : (((void *)0)), __eCInstance1;
});
__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&function->body->__anon1.compound.context->symbols, (struct __eCNameSpace__eC__containers__BTNode *)thisSymbol);
...
__eCInstance1->refCount = 1, __eCInstance1->kind = 0, __eCInstance1;
}), __eCInstance2;
});
if(function->body)
{
...
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*list), (((void *)0)), MkSpecifierExtended(MkExtDeclAttrib(MkAttrib(ATTRIB, MkListOne(MkAttribute(__eCNameSpace__eC__types__CopyString("unused"), (((void *)0))))))));
curContext = prevContext;
}
decl->symbol = (((void *)0));
if(!function->body->__anon1.compound.declarations)
function->body->__anon1.compound.declarations = MkList();
__eCMethod___eCNameSpace__eC__containers__OldList_Insert((&*function->body->__anon1.compound.declarations), (((void *)0)), decl);
}
}
}
}
...
struct ClassDef * def;
struct External * external = curExternal;
struct __eCNameSpace__eC__types__Class * regClass = symbol ? symbol->__anon1.registered : (((void *)0));
...
{
struct __eCNameSpace__eC__types__Class * backThisClass = thisClass;
...
struct Symbol * thisSymbol = (thisSymbol = __eCNameSpace__eC__types__eInstance_New(__eCClass_Symbol), thisSymbol->string = __eCNameSpace__eC__types__CopyString("this"), thisSymbol->type = regClass ? MkClassType(regClass->fullName) : (((void *)0)), thisSymbol);
...
__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&prop->setStmt->__anon1.compound.context->symbols, (struct __eCNameSpace__eC__containers__BTNode *)thisSymbol);
}
...
__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&prop->getStmt->__anon1.compound.context->symbols, (struct __eCNameSpace__eC__containers__BTNode *)thisSymbol);
}
...
__eCMethod___eCNameSpace__eC__containers__BinaryTree_Add(&prop->issetStmt->__anon1.compound.context->symbols, (struct __eCNameSpace__eC__containers__BTNode *)thisSymbol);
}
...
__eCNameSpace__eC__types__eSystem_RegisterFunction("SetYydebug", "void SetYydebug(bool b)", SetYydebug, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("SetThisClass", "void SetThisClass(eC::types::Class c)", SetThisClass, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetThisClass", "eC::types::Class GetThisClass(void)", GetThisClass, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintExpression", "void PrintExpression(Expression exp, char * string)", PrintExpression, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessTemplateParameterType", "Type ProcessTemplateParameterType(TemplateParameter param)", ProcessTemplateParameterType, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("NeedCast", "bool NeedCast(Type type1, Type type2)", NeedCast, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintInt", "char * PrintInt(int64 result)", PrintInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintUInt", "char * PrintUInt(uint64 result)", PrintUInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintInt64", "char * PrintInt64(int64 result)", PrintInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintUInt64", "char * PrintUInt64(uint64 result)", PrintUInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintHexUInt", "char * PrintHexUInt(uint64 result)", PrintHexUInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintHexUInt64", "char * PrintHexUInt64(uint64 result)", PrintHexUInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintShort", "char * PrintShort(short result)", PrintShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintUShort", "char * PrintUShort(uint16 result)", PrintUShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintChar", "char * PrintChar(char result)", PrintChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintUChar", "char * PrintUChar(byte result)", PrintUChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintFloat", "char * PrintFloat(float result)", PrintFloat, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintDouble", "char * PrintDouble(double result)", PrintDouble, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpInt", "bool GetOpInt(Operand op2, int * value2)", GetOpInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetInt", "bool GetInt(Expression exp, int * value2)", GetInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUInt", "bool GetOpUInt(Operand op2, uint * value2)", GetOpUInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUInt", "bool GetUInt(Expression exp, uint * value2)", GetUInt, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpInt64", "bool GetOpInt64(Operand op2, int64 * value2)", GetOpInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetInt64", "bool GetInt64(Expression exp, int64 * value2)", GetInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUInt64", "bool GetOpUInt64(Operand op2, uint64 * value2)", GetOpUInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUInt64", "bool GetUInt64(Expression exp, uint64 * value2)", GetUInt64, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpIntPtr", "bool GetOpIntPtr(Operand op2, intptr * value2)", GetOpIntPtr, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetIntPtr", "bool GetIntPtr(Expression exp, intptr * value2)", GetIntPtr, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUIntPtr", "bool GetOpUIntPtr(Operand op2, uintptr * value2)", GetOpUIntPtr, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUIntPtr", "bool GetUIntPtr(Expression exp, uintptr * value2)", GetUIntPtr, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpIntSize", "bool GetOpIntSize(Operand op2, intsize * value2)", GetOpIntSize, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetIntSize", "bool GetIntSize(Expression exp, intsize * value2)", GetIntSize, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUIntSize", "bool GetOpUIntSize(Operand op2, uintsize * value2)", GetOpUIntSize, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUIntSize", "bool GetUIntSize(Expression exp, uintsize * value2)", GetUIntSize, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpShort", "bool GetOpShort(Operand op2, short * value2)", GetOpShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetShort", "bool GetShort(Expression exp, short * value2)", GetShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUShort", "bool GetOpUShort(Operand op2, uint16 * value2)", GetOpUShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUShort", "bool GetUShort(Expression exp, uint16 * value2)", GetUShort, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpChar", "bool GetOpChar(Operand op2, char * value2)", GetOpChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetChar", "bool GetChar(Expression exp, char * value2)", GetChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpUChar", "bool GetOpUChar(Operand op2, byte * value2)", GetOpUChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetUChar", "bool GetUChar(Expression exp, byte * value2)", GetUChar, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpFloat", "bool GetOpFloat(Operand op2, float * value2)", GetOpFloat, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetFloat", "bool GetFloat(Expression exp, float * value2)", GetFloat, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOpDouble", "bool GetOpDouble(Operand op2, double * value2)", GetOpDouble, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetDouble", "bool GetDouble(Expression exp, double * value2)", GetDouble, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeClassMembers", "void ComputeClassMembers(eC::types::Class _class, bool isMember)", ComputeClassMembers, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeModuleClasses", "void ComputeModuleClasses(eC::types::Module module)", ComputeModuleClasses, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeTypeSize", "int ComputeTypeSize(Type type)", ComputeTypeSize, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("AddMembers", "int AddMembers(External neededBy, eC::containers::OldList * declarations, eC::types::Class _class, bool isMember, uint * retSize, eC::types::Class topClass, bool * addedPadding)", AddMembers, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareStruct", "External DeclareStruct(External neededBy, const char * name, bool skipNoHead, bool needDereference)", DeclareStruct, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("_DeclareStruct", "External _DeclareStruct(External neededBy, const char * name, bool skipNoHead, bool needDereference, bool fwdDecl)", _DeclareStruct, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareProperty", "void DeclareProperty(External neededBy, eC::types::Property prop, char * setName, char * getName)", DeclareProperty, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("Dereference", "Type Dereference(Type source)", Dereference, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessMemberInitData", "void ProcessMemberInitData(MemberInit member, eC::types::Class _class, eC::types::Class * curClass, eC::types::DataMember * curMember, eC::types::DataMember * subMemberStack, int * subMemberStackPos)", ProcessMemberInitData, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessInstantiationType", "void ProcessInstantiationType(Instantiation inst)", ProcessInstantiationType, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareType", "void DeclareType(External neededFor, Type type, bool needDereference, bool forFunctionDef)", DeclareType, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareTypeForwardDeclare", "void DeclareTypeForwardDeclare(External neededFor, Type type, bool needDereference, bool forFunctionDef)", DeclareTypeForwardDeclare, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("FindTemplateArg", "eC::types::ClassTemplateArgument * FindTemplateArg(eC::types::Class _class, TemplateParameter param)", FindTemplateArg, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("SetupTemplatesContext", "Context SetupTemplatesContext(eC::types::Class _class)", SetupTemplatesContext, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("FinishTemplatesContext", "void FinishTemplatesContext(Context context)", FinishTemplatesContext, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessMethodType", "void ProcessMethodType(eC::types::Method method)", ProcessMethodType, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessPropertyType", "void ProcessPropertyType(eC::types::Property prop)", ProcessPropertyType, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareMethod", "void DeclareMethod(External neededFor, eC::types::Method method, const char * name)", DeclareMethod, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ReplaceThisClass", "char * ReplaceThisClass(eC::types::Class _class)", ReplaceThisClass, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ReplaceThisClassType", "Type ReplaceThisClassType(eC::types::Class _class)", ReplaceThisClassType, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ReplaceThisClassSpecifiers", "void ReplaceThisClassSpecifiers(eC::containers::OldList specs, eC::types::Class _class)", ReplaceThisClassSpecifiers, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareFunction", "bool DeclareFunction(External neededFor, eC::types::GlobalFunction function, char * name)", DeclareFunction, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareGlobalData", "void DeclareGlobalData(External neededFor, GlobalData data)", DeclareGlobalData, module, 2);
class = __eCNameSpace__eC__types__eSystem_RegisterClass(5, "Conversion", 0, sizeof(struct Conversion), 0, (void *)0, (void *)0, module, 2, 1);
...
__eCClass_Conversion = class;
__eCNameSpace__eC__types__eClass_AddDataMember(class, (((void *)0)), (((void *)0)), 0, sizeof(void *) > 4 ? sizeof(void *) : 4, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("MatchTypes", "bool MatchTypes(Type source, Type dest, eC::containers::OldList conversions, eC::types::Class owningClassSource, eC::types::Class owningClassDest, bool doConversion, bool enumBaseType, bool acceptReversedParams, bool isConversionExploration, bool warnConst)", MatchTypes, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("MatchWithEnums_NameSpace", "bool MatchWithEnums_NameSpace(eC::types::NameSpace nameSpace, Expression sourceExp, Type dest, char * string, eC::containers::OldList conversions)", MatchWithEnums_NameSpace, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ModuleVisibility", "bool ModuleVisibility(eC::types::Module searchIn, eC::types::Module searchFor)", ModuleVisibility, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("MatchWithEnums_Module", "bool MatchWithEnums_Module(eC::types::Module mainModule, Expression sourceExp, Type dest, char * string, eC::containers::OldList conversions)", MatchWithEnums_Module, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("MatchTypeExpression", "bool MatchTypeExpression(Expression sourceExp, Type dest, eC::containers::OldList conversions, bool skipUnitBla, bool warnConst)", MatchTypeExpression, module, 2);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ReadString", "void ReadString(char * output, uint outputSize, const char * string)", ReadString, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("UnescapeString", "int UnescapeString(char * d, char * s, int len)", UnescapeString, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("OffsetEscapedString", "char * OffsetEscapedString(char * s, int len, int offset)", OffsetEscapedString, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetOperand", "Operand GetOperand(Expression exp)", GetOperand, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PopulateInstance", "void PopulateInstance(Instantiation inst)", PopulateInstance, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeInstantiation", "void ComputeInstantiation(Expression exp)", ComputeInstantiation, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("CallOperator", "void CallOperator(Expression exp, Expression exp1, Expression exp2, Operand op1, Operand op2)", CallOperator, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeExpression", "void ComputeExpression(Expression exp)", ComputeExpression, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("modifyPassAsTemplate", "void modifyPassAsTemplate(Type * typePtr, bool value)", modifyPassAsTemplate, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("CheckTemplateTypes", "void CheckTemplateTypes(Expression exp)", CheckTemplateTypes, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("FindSymbol", "Symbol FindSymbol(const char * name, Context startContext, Context endContext, bool isStruct, bool globalNameSpace)", FindSymbol, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintType", "void PrintType(Type type, char * string, bool printName, bool fullName)", PrintType, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("PrintTypeNoConst", "void PrintTypeNoConst(Type type, char * string, bool printName, bool fullName)", PrintTypeNoConst, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("FindMemberAndOffset", "Type FindMemberAndOffset(Type type, char * string, uint * offset)", FindMemberAndOffset, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("GetParseError", "bool GetParseError(void)", GetParseError, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ParseExpressionString", "Expression ParseExpressionString(char * expression)", ParseExpressionString, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ReplaceExpContents", "void ReplaceExpContents(Expression checkedExp, Expression newExp)", ReplaceExpContents, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ApplyAnyObjectLogic", "void ApplyAnyObjectLogic(Expression e)", ApplyAnyObjectLogic, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ApplyLocation", "void ApplyLocation(Expression exp, Location loc)", ApplyLocation, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("RelatedUnits", "bool RelatedUnits(eC::types::Class c1, eC::types::Class c2)", RelatedUnits, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ProcessExpressionType", "void ProcessExpressionType(Expression exp)", ProcessExpressionType, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("DeclareFunctionUtil", "void DeclareFunctionUtil(External neededBy, const String s)", DeclareFunctionUtil, module, 1);
__eCNameSpace__eC__types__eSystem_RegisterFunction("ComputeDataTypes", "void ComputeDataTypes(void)", ComputeDataTypes, module, 1);
}
