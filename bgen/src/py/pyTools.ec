            ...
            if(!(c.is_class || c.isInstance)) // class filter here
            {
               ...
               else
               {
                  while(stack.count)
                  {
                     if(entering)
                     {
                        DataMember dm = (DataMember)(uintptr)stack.last.prev.data;
                     ...
                     else
                     {
                        ...
                        // error: incompatible types when initializing type 'void *' using type 'struct __eCNameSpace__eC__containers__Iterator'
