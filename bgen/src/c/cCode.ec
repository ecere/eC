...
static void cInCodeInitStart(AST out, CGen g)
{
   ...
   if(g.lib.ecrt)
   {
      ...
      z.concatx("LIB_EXPORT ", g.sym.application, " ", g.lib.bindingName,
            "_init(", g_.sym.module, " fromModule, C(bool) obsolete, C(bool) guiApp, int argc, char * argv[])", ln);
      z.concatx("{", ln);
      ...
      z.concatx("      ", g_.sym.module, " module = Module_load(fromModule, \"ecrt\", ", _publicAccess, ");", ln);
